...
export default function ScheduleServices({ services }) {
  ...
  return (
    <>
      <UserProvider>
        <main className=" bg-gray-50 flex flex-col items-center pt-12 pb-20">
          <div className="w-full max-w-5xl px-6">
            <header className="mb-6">
              ...
              <p className="text-gray-600 mt-2">
                Pick a date from the calendar and we'll confirm availability.
              ...
              <aside className="flex flex-col justify-between bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                <div>
                  ...
                  <ul className="text-sm text-gray-600 space-y-2">
                    <li>
                      <strong>Business hours:</strong> Mon–Sat, 8:00 AM – 6:00
                      PM
                    </li>
                    <li>
                      <strong>How it works:</strong> Select a date, add details,
                      confirm appointment.
                    </li>
                    <li>
                      <strong>Cancellation:</strong> 24-hour notice requested.
                    </li>
                  </ul>
                </div>
