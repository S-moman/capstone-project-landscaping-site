        ...
        <section className="bg-white rounded-lg shadow-sm p-8 flex flex-col md:flex-row items-center gap-8">
          <div className="w-full md:w-1/2">
            ...
            <p className="text-gray-600 mb-6">
              Professional residential and commercial services — timely,
              insured, and tailored to your property. Get a free, no-obligation
              quote today and keep your grounds safe and beautiful all year
              long.
            </p>

            <div className="flex flex-col sm:flex-row sm:items-center sm:space-x-4 space-y-3 sm:space-y-0">
              <Link to="/getquote" aria-label="Get a quote">
                <button className="w-full sm:w-auto inline-block bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-2 rounded shadow focus:outline-none focus:ring-2 focus:ring-green-300">
                  Get Quote
                </button>
              </Link>

              <Link to="/services" aria-label="View services">
                <button className="w-full sm:w-auto inline-block border border-gray-200 bg-white hover:bg-gray-50 text-gray-800 font-medium px-6 py-2 rounded focus:outline-none">
                  Services
                </button>
              </Link>
            </div>
        ...
        <section className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-white rounded-lg p-5 shadow-sm flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Trusted professionals with years of local experience.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-5 shadow-sm flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Prompt responses and dependable scheduling for every season.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-5 shadow-sm flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Clear quotes with no hidden fees so you can plan with
                confidence.
              </p>
            </div>
          </div>
